...
/// <summary>Italic/emphasis text delimited by <c>_content_</c>.</summary>
public sealed class EmphasisInlineNode : InlineNode
{
    public new required IReadOnlyList<InlineNode> Children { get; init; }

    /// <summary>
    /// Optional roles from <c>[.role]_text_</c> syntax. When non-empty, the renderer
    /// adds a <c>class="..."</c> attribute to the <c>&lt;em&gt;</c> element.
    /// </summary>
    ...
    public override AstNodeKind Kind => AstNodeKind.InlineEmphasis;
