...
/// <summary>Monospace/code text delimited by <c>`content`</c>.</summary>
public sealed class MonospaceInlineNode : InlineNode
{
    ...
    /// adds a <c>class="..."</c> attribute to the <c>&lt;code&gt;</c> element.
    /// </summary>
    ...
    public override AstNodeKind Kind => AstNodeKind.InlineMonospace;
