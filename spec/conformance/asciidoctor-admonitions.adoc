////
Source: https://raw.githubusercontent.com/asciidoctor/asciidoc-docs/main/docs/modules/blocks/pages/admonitions.adoc
License: MIT (Asciidoctor project)
...
[#ex-label]
----
// include removed for conformance testing
----
